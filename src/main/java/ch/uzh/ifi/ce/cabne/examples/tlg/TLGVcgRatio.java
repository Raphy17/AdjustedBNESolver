...
import ch.uzh.ifi.ce.cabne.domains.TLG.VcgRatio;
import ch.uzh.ifi.ce.cabne.domains.TLG.ZeroRatio;
...
public class TLGVcgRatio {
	...
	public static void main(String[] args) throws InterruptedException, IOException {		
		...
		context.setMechanism(new VcgRatio());
		//context.setMechanism(new ZeroRatio());
		...
		bneAlgo.setInitialStrategy(3, UnivariatePWLStrategy.makeTruthful(0.0, 2.0));
		bneAlgo.makeBidderSymmetric(1, 0);
		bneAlgo.makeBidderSymmetric(2, 0);				//questions, should 2 and 1 also be symmetric?
//		bneAlgo.makeBidderNonUpdating(1);
